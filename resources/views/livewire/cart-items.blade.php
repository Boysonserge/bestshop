...
{{--                            <ion-icon name="trash-outline"></ion-icon>--}}
                            <button wire:click="deleteCart('{{$carts->rowId}}')" class="bg-red-500">Remove</button>
                        </td>
                ...
                <tr class="bg-gray-100 text-gray-800">
                    ...
                    <th colspan="2" class="px-6 py-4 font-medium text-gray-900  whitespace-nowrap">
                        <button wire:click.prevent="proceed()"
                                type="button"
                                class="w-full px-3 py-2 text-xs font-medium text-center text-white bg-yellow-900
